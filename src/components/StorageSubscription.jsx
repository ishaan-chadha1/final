...
function StorageSubscription() {
  ...
  return (
    ...
    >
      ...
      <div className="w-[100%] h-[50px] md:h-[520px] xl:h-[150px] p-6 flex flex-col gap-4 md:gap-6">
      ...
      <div
        className={`${styles.paddingX} mt-[2rem] md:mt-[4rem] flex flex-wrap flex-row justify-center gap-6`}
      >
